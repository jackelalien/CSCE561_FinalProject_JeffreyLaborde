...
using CSCE561_jxl7581_FinalProject.Util;
using CSCE561_jxl7581_FinalProject.Parser;
...
namespace CSCE561_jxl7581_FinalProject
{
    public class EnglishNameFinder
    {
        ...
        /// <summary>
        /// Get Names from the models.
        /// </summary>
        /// <param name="models">Passes in the list of trained models to retrieve and build on.</param>
        /// <param name="data">The sentence data to pass through.</param>
        /// <returns></returns>
