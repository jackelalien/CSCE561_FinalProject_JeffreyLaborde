...
namespace CSCE561_jxl7581_FinalProject.Parser
{
	/// <summary>
	...
	public class MaximumEntropyParser
	{
		...
		public static SharpEntropy.GisModel TrainModel(string trainingFile, EventType modelType, string headRulesFile, int iterations, int cutoff)
		{
			...
			SharpEntropy.ITrainingEventReader eventReader = new Parser.ParserEventReader(new SharpEntropy.PlainTextByLineDataReader(new System.IO.StreamReader(trainingFile)), rules, modelType);
