...
namespace CSCE561_jxl7581_FinalProject.SharpEntropy
{
	...
	public class GisTrainer : IO.IGisModelReader
	{
		...
		public virtual void TrainModel(int iterations, ITrainingDataIndexer dataIndexer)
		{
            ...
            Console.WriteLine("\tNumber of Event Tokens: " + mTokenCount);
            Console.WriteLine("\tNumber of Outcomes: " + mOutcomeCount);
            Console.WriteLine("\tNumber of Predicates: " + mPredicateCount);
